...
FitLoop is a full-stack e-commerce web application built with **Next.js** for the frontend and **Flask (Python)** for the backend. The application allows users to browse products, manage their shopping cart, and complete secure online payments using **Paytm Payment Gateway**. It also includes an admin panel for managing products, users, and customer orders.
...
- Secure checkout with **Paytm Payment Gateway**
...
The application uses **Paytm Payment Gateway** for secure online transactions.
...
fitloop-ecommerce/
│
├── backend/                 # Flask backend and Paytm integration
...
| `PAYTM_CALLBACK_URL` | Callback URL for Paytm payment response |
